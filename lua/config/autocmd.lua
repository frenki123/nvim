...
vim.api.nvim_create_autocmd({'BufLeave', 'BufWinLeave', 'WinLeave', 'FocusLost'}, {
  desc = 'Turn off relative numbers when window is not active',
  group = vim.api.nvim_create_augroup('rellative-num-off', { clear = true }),
  callback = function()
...
vim.api.nvim_create_autocmd({'BufEnter', 'BufWinEnter', 'WinEnter', 'FocusGained'}, {
  ...
  group = vim.api.nvim_create_augroup('rellative-num-on', { clear = true }),
  callback = function()
...
vim.api.nvim_create_autocmd('ModeChanged', {
  ...
  group = vim.api.nvim_create_augroup('highlight-off-modechg', { clear = true }),
  callback = function()
		vim.cmd.nohlsearch()
  end,
})
